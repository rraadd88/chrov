...
# %% auto 0
__all__ = ['get_species_name', 'get_annots', 'is_protein_coding', 'get_ts', 'get_es', 'get_cs', 'get_ranges', 'intersect',
           'map_back_feat_ids', 'intersect_with_seqs', 'intersect_with_feats', 'get_ts_data']
...
def intersect_with_feats(
    ...
    assert (
        df3_[feat2_id].isnull().sum() == df3_[mapped_feat_start].isnull().sum()
